...
class Play extends React.Component {
    ...
    componentDidMount() {
        ...
        $("#rect0,#rect1,#rect2").css("height", window.innerHeight / 4);
        $("#rect0,#rect1,#rect2").css("visibility", "hidden");
        this.setState({ height: $("#area").height() - $("#rect0").height() - $("#stats").height() - 1 }, () => { console.log("height"); });
        $('#myModal').modal({
            backdrop: 'static',
            keyboard: false,
            show: false
        ...
        $("#rect0,#rect1,#rect2").on('click', (event) => {
    ...
    render() {
        ...
        return <div id="area" className="bg-success border border-dark rounded-lg mx-auto">
            <div className="d-flex flex-column">
                <div id="stats" className="d-flex flex-row bg-dark text-monospace text-light justify-content-around">
